...
"""
=============================================================================
Phase 5 - FLUX Unseen Prompts LoRA Inference (epoch-0)
=============================================================================
Generates images for the same 50 unseen prompts using FLUX + LoRA fine-tuned
...
def main():
    parser = argparse.ArgumentParser(description="FLUX Unseen Prompts LoRA Inference")
    ...
    print(f"[INFO] Running FLUX LoRA inference on {total_prompts} unseen prompts (Index {start_idx+1} to {end_idx})")

    # 2. Run Fine-tuned Model (after_unseen_{index})
    ...
    print(f"\n[SUCCESS] Completed FLUX LoRA generation. Outputs saved in: {output_dir.resolve()}")
